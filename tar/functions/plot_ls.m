...
figure('Name', 'LS, horizon 1, all')
subplot(1, 2, 1)
plot(VAR.ls(:,:,1)), title('VAR'), xlabel('Time'), ylim([-30 5])
subplot(1, 2, 2)
plot(TAR.ls(:,:,1)), title('TAR'), xlabel('Time'), ylim([-30 5])
legend(vnamesvar)

figure('Name', 'LS, horizon max, all')
subplot(1, 2, 1)
plot(VAR.ls(:,:,end)), title('VAR'), xlabel('Time'), ylim([-20 5])
subplot(1, 2, 2)
plot(TAR.ls(:,:,end)), title('TAR'), xlabel('Time'), ylim([-20 5])
legend(vnamesvar)
