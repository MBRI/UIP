...
% Unlike many other procedures, this one is immune to accuracy failures in 
% the estimation of multimodal densities with widely separated modes (see examples).
%
